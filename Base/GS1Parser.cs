...
namespace MiCLAS.MDE.Base
{
    public static class GS1Parser
    {
        ...
        private static bool HasCheckSum
        {
            get { return GS1Parser.hasCheckSum; }
            set { GS1Parser.hasCheckSum = value; }
        }

        private static char GroupSeparator
        {
            get { return GS1Parser.groupSeparator; }
            set { GS1Parser.groupSeparator = value; }
        }

        private static string EAN128StartCode
        {
            get { return GS1Parser.ean128StartCode; }
            set { GS1Parser.ean128StartCode = value; }
        }
        ...
        static GS1Parser()
        {
            ...
            Add("10", "Charge_Number", 2, DataType.Alphanumeric, 20, true);//Charge
            Add("11", "ProducerDate_JJMMDD", 2, DataType.Numeric, 6, false);//Herstelldatum 
            ...
            Add("17", "ExpiryDate_JJMMDD", 2, DataType.Numeric, 6, false);//Verfallsdatum 
            Add("20", "ProductModel", 2, DataType.Numeric, 2, false);
            Add("21", "SerialNumber", 2, DataType.Alphanumeric, 20, true);//Seriennummer
            ...
            Add("422", "BasisCountryOfTheWares_ISO3166Format", 3, DataType.Numeric, 3, false);//Ursprungsland
            ...
            Add("91", "Artikelnummer", 2, DataType.Alphanumeric, 90, true);//ArtikelNr
            Add("92", "Company specific", 2, DataType.Alphanumeric, 90, true);
            Add("93", "Company specific", 2, DataType.Alphanumeric, 90, true);
            Add("94", "Company specific", 2, DataType.Alphanumeric, 90, true);
            Add("95", "Company specific", 2, DataType.Alphanumeric, 90, true);
            Add("96", "Company specific", 2, DataType.Alphanumeric, 90, true);
            Add("97", "Company specific", 2, DataType.Alphanumeric, 90, true);
            Add("98", "Company specific", 2, DataType.Alphanumeric, 90, true);
            Add("99", "Company specific", 2, DataType.Alphanumeric, 90, true);
        ...
        public static Dictionary<AII, string> Parse(string data, bool throwException = false)
        {
            ...
            while (index < data.Length)
            {
                ...
                var ai = GetAI(data.Trim(null), ref index);
                if (ai == null)
                {
                    if (throwException)
